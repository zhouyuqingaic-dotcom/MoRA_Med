...
class VQAMED2019TrainCollator:
    ...
    def __call__(
        ...
        if not batch:
            raise ValueError(
                "VQAMED2019TrainCollator 收到了空 batch。"
            )
